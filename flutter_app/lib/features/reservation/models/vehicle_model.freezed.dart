...
bool operator ==(Object other) {
  final _this = this as VehicleModel;
...
String toString() {
  final _this = this as VehicleModel;
  return 'VehicleModel(id: ${_this.id}, slug: ${_this.slug}, name: ${_this.name}, vehicle_make_id: ${_this.vehicle_make_id})';
}
...
class _VehicleModel implements VehicleModel {
  const _VehicleModel({required this.id, required this.slug, required this.name, required this.vehicle_make_id});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _VehicleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.vehicle_make_id, vehicle_make_id) || other.vehicle_make_id == vehicle_make_id));
}
...
@override
String toString() {
    return 'VehicleModel(id: $id, slug: $slug, name: $name, vehicle_make_id: $vehicle_make_id)';
}
