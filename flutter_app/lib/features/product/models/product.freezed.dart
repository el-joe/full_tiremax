...
class _Product implements Product {
  const _Product({required this.id, required this.sku, required this.type, required this.name, required this.short_description, this.description, this.pattern_name, this.usage_notes, required this.price, this.sale_price, required this.effective_price, required this.has_discount, required this.is_flash_sale, this.flash_sale, required this.stock, required this.in_stock, required this.manufacture_year, required this.manufacturer_warranty_months, required this.agency_warranty_months, this.expert_rating, required this.sales_count, required this.views_count, required this.is_featured,  List<String> badges = const <String>[],  List<ProductImage> images = const <ProductImage>[], this.primary_image, required this.brand, this.category, this.tire_spec, this.battery_spec}): _badges = badges,_images = images;
