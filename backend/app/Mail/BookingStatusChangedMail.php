...
class BookingStatusChangedMail extends TransactionalMail
{
    ...
    protected function subjectKey(): string { return 'emails.booking_status.subject'; }
    ...
    {
        return ['booking' => $this->booking->loadMissing(['branch', 'service']), 'kind' => 'booking_status', 'from' => $this->prev];
    }
}
