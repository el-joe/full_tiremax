...
class VehicleController extends Controller
{
    ...
    {
        $q = Vehicle::query()->with(['model.make', 'model.translations', 'model.make.translations', 'translations']);
    ...
    {
        $vehicle->load(['model.make', 'model.translations', 'model.make.translations', 'translations']);
