...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tires = [
            ...
            // ---- 215/55R17 mid-size crossover ----
            [
                'sku' => 'MCH-PRI4-215-55-17',
                'brand' => 'michelin',
                'category' => 'summer-tires',
                'price' => 92000,
                'sale_price' => null,
                ...
                'en' => ['name' => 'Michelin Primacy 4', 'short_description' => 'Premium all-season comfort tyre', 'pattern_name' => 'Primacy 4'],
                'ar' => ['name' => 'ميشلان برايمسي 4', 'short_description' => 'إطار مريح ممتاز لجميع المواسم', 'pattern_name' => 'برايمسي 4'],
                'spec' => ['width' => 215, 'aspect_ratio' => 55, 'rim_diameter' => 17, 'load_index' => '94V', 'speed_rating' => 'V', 'usage_type' => 'comfort', 'runflat' => false],
            ],
            // ---- 235/50R18 crossover/SUV ----
            [
                'sku' => 'CNT-PC6-235-50-18',
                'brand' => 'continental',
                'category' => 'all-season-tires',
                'price' => 110000,
                'sale_price' => null,
                ...
                'featured' => false,
                'badges' => [],
                'en' => ['name' => 'Continental PremiumContact 6', 'short_description' => 'Premium all-season SUV tyre', 'pattern_name' => 'PremiumContact 6'],
                'ar' => ['name' => 'كونتيننتال بريميوم كونتاكت 6', 'short_description' => 'إطار SUV ممتاز لجميع المواسم', 'pattern_name' => 'بريميوم كونتاكت 6'],
                'spec' => ['width' => 235, 'aspect_ratio' => 50, 'rim_diameter' => 18, 'load_index' => '101V', 'speed_rating' => 'V', 'usage_type' => 'all-season', 'runflat' => false],
            ],
        ];
