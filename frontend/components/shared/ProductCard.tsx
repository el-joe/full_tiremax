...
const ProductCard = ({ product }: Props) => {
  ...
  return (
    <Link href={`/store/${product?.id}`}>
      ...
      >
        <Box
          p={{ base: "6px", md: "9px", xl: "12px", "2xl": "16px" }}
          bg={"#EEEEEE"}
        ...
        <Card.Body
          ...
          alignItems={"start"}
          p="0"
          pt={{ base: "12px", md: "16px", xl: "20px", "2xl": "24px" }}
        >
          <Badge
          ...
          <HStack>
            {product?.battery_spec?.battery_type && (
              <Badge
                fontSize={{ base: "6px", md: "8px", xl: "10px" }}
                fontWeight={"bold"}
                rounded="12px"
