        ...
        <VStack gap={"32px"} w={"320px"}>
            <Box w={"full"}>
                <HStack justify={"space-between"} alignItems={"center"}>
                    ...
                    <Button variant={"ghost"} fontSize={"12px"} fontWeight={"semibold"} color={"black"} _hover={{ color: "white" }}>{t("clearFilters")}</Button>
                </HStack>
            ...
            <Button w="full" rounded={"16px"} fontSize={"18px"} fontWeight={"bold"} p="16px"><SearchIcon />{t("applyFilters")}</Button>
        </VStack>
    )
}
