    ...
    return (
        <Box>
            ...
            <Box justifySelf={"center"} mt={"68px"}>
                <Pagination currentPage={paginationInfo.pagination.current_page} itemsCount={paginationInfo.pagination.total} pageSize={paginationInfo.pagination.per_page} prefixName='pagination' />
            </Box>
        </Box>
    )
}
