...
const FoundTireBox = () => {
    ...
    return (
        <Tabs.Root defaultValue="foundByVehicle" maxW={"1214px"} bg={"bg"} rounded={"24px"} overflow={"hidden"}>
            ...
            <Tabs.Content value="foundByVehicle" p={{ base: "8px", md: "19px", xl: "31px" }} dir={dir}><FoundByVehicle /></Tabs.Content>
            <Tabs.Content value="foundBySize" p={{ base: "8px", md: "19px", xl: "31px" }} dir={dir}><FoundBySize /></Tabs.Content>
        </Tabs.Root>
    )
}
...
const FoundByVehicle = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
            <HStack gap={{ base: "4px", md: "12px", xl: "24px" }} alignItems="end" flexWrap={"wrap"}>
                <DropSelectList list={[{ label: "option1", value: "option1" }, { label: "option2", value: "option2" }]} label={t("category")} placeholder={t("selectCategory")} name="category" containerProps={{ flex: 1 }} triggerProps={{ rounded: "12px" }} />
    ...
    return (
        <form onSubmit={onSubmit}>
            <HStack gap={{ base: "4px", md: "12px", xl: "24px" }} alignItems="end" flexWrap={"wrap"}>
                ...
                <Button rounded={"12px"} type='submit' w={{ base: "full", md: "auto" }}>{t("findYourTireNow")} <SearchIcon /></Button>
            </HStack>
        </form>)
}