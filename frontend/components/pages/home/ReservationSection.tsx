...
const ReservationSection = async () => {
  ...
  return (
    <Container
      bg="primary"
      mb="21px"
      p={{ base: "40px", md: "60px", xl: "112px" }}
    >
      <HStack
        gap={{ base: "34px", md: "60px", xl: "130px" }}
      ...
      >
        <Box flex="1">
          ...
          >
            {" "}
            <StarsIcon size="sm" /> {t("quickAndEasyBooking")}
          </Badge>
          <Heading
            as={"h2"}
            fontSize={"48px"}
          ...
          >
            <Highlight
              query={t("now!")}
              styles={{ color: "white", display: "block" }}
            >
              {t("bookYourCarServiceNow")}
            </Highlight>
          </Heading>
        ...
        <Box flex="1">
          <Image
            src={
              locale === "ar"
                ? "/images/reservationSteps.png"
                : "/images/reservationStepsEN.png"
            }
            alt=""
          />
        </Box>
