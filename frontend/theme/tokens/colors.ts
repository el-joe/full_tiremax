...
export const colors = defineTokens.colors({
  ...
  black: { value: "var(--color-black)" },
  "black-2": { value: "var(--color-black-2)" },
  myGray: { value: "var(--color-gray)" },
  "gray-2": { value: "var(--color-gray-2)" },
  "gray-3": { value: "var(--color-gray-3)" },
  "gray-4": { value: "var(--color-gray-4)" },
  myRed: { value: "var(--color-red)" },
  myBlue: { value: "var(--color-blue)" },
  myGreen: { value: "var(--color-green)" },
  "dar-yellow": { value: "var(--color-dark-yellow)" },
  transparent: {
    value: "transparent",
  },
  current: {
